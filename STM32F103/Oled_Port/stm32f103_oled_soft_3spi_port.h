#ifndef STM32F103_SOFT_3SPI_PORT_H
#define STM32F103_SOFT_3SPI_PORT_H
...
void OLED_send_numData(uint8_t *p,uint8_t num);//向屏幕发送num个数据
void OLED_send_numCmd(uint8_t *p,uint8_t num);//向屏幕发送num个命令
